...
export const metadata: Metadata = {
  ...
  title: {
    default: 'ConversaCommerce — Tu vendedor con IA en WhatsApp, 24/7',
    template: '%s · ConversaCommerce',
  },
  description:
  ...
  applicationName: 'ConversaCommerce',
  keywords: [
  ...
  authors: [{ name: 'ConversaCommerce' }],
  creator: 'ConversaCommerce',
  alternates: { canonical: SITE },
  openGraph: {
    type: 'website',
    locale: 'es_CO',
    url: SITE,
    siteName: 'ConversaCommerce',
  ...
  twitter: {
    ...
    title: 'ConversaCommerce — Tu vendedor con IA en WhatsApp',
